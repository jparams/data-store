...
public class FilteredReducerIT
{
    ...
    public void setUp()
    {
        ...
        index = subject.index("", IndexDefinition.withKeyMapping(Person::getFirstName).withReducer(new FilteredReducer<>(person -> person.getLastName() == null)));
    }

    @Test
    public void testReducer()
    {
        final Person person1 = PersonBuilder.aPerson().withId(1L).withFirstName("Bob").withLastName("Johnson").build();
