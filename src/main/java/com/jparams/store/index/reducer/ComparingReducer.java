...
abstract class ComparingReducer<K, V> implements Reducer<K, V>
{
    ...
    <C extends Comparable<? super C>> ComparingReducer(final Function<V, C> valueProvider, final boolean nullGreater)
    {
    ...
    @SuppressWarnings("unchecked")
    <C> ComparingReducer(final Function<V, C> valueProvider, final Comparator<C> comparator, final boolean nullGreater)
    {
        this.valueProvider = valueProvider;
    ...
    abstract int compare(Object value1, Object value2, Comparator<Object> comparator, boolean nullGreater);
}
